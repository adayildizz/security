...
const (
	Messenger_Send_FullMethodName = "/msg.Messenger/Send"
)
...
func (c *messengerClient) Send(ctx context.Context, in *SendRequest, opts ...grpc.CallOption) (*SendReply, error) {
...
func (UnimplementedMessengerServer) Send(context.Context, *SendRequest) (*SendReply, error) {
