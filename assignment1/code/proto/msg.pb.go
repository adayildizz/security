...
func (x *SendReply) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
const file_proto_msg_proto_rawDesc = "" +
	"\n" +
	"\x0fproto/msg.proto\x12\x03msg\"'\n" +
	"\vSendRequest\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"#\n" +
	"\tSendReply\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status27\n" +
	"\tMessenger\x12*\n" +
	"\x04Send\x12\x10.msg.SendRequest\x1a\x0e.msg.SendReply\"\x00B\x1eZ\x1cassignment1/code/proto;protob\x06proto3"
...
var file_proto_msg_proto_goTypes = []any{
	...
	(*SendReply)(nil),   // 1: msg.SendReply
}
var file_proto_msg_proto_depIdxs = []int32{
	0, // 0: msg.Messenger.Send:input_type -> msg.SendRequest
	1, // 1: msg.Messenger.Send:output_type -> msg.SendReply
